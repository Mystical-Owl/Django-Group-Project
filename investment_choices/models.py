...
class InvestmentChoice (models.Model) :
    investment_name = models.CharField (max_length=50, blank=True, null=True)
    investment_type = models.ForeignKey (InvestmentType, on_delete=models.CASCADE, blank=True, null=True)
